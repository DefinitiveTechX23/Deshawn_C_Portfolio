  ...
  return (
    <div className="w-full min-h-screen bg-orange-500">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/15 via-background to-secondary/20 w-full min-h-screen flex items-center">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6">
              ...
              <br />
              a Web <span className="text-secondary">Developer</span>
            </h1>
            <p className="text-xl sm:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              My goal is to create beautiful, functional web experiences and applications. Currently on a journey to master HTML, CSS,
        ...
        {/* Decorative elements */}
        <div className="absolute top-20 left-10 w-24 h-24 bg-primary/30 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-10 w-36 h-36 bg-secondary/30 rounded-full blur-xl"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-primary/20 rounded-full blur-lg"></div>
        <div className="absolute bottom-1/3 right-1/4 w-20 h-20 bg-secondary/25 rounded-full blur-lg"></div>
      </section>

      {/* Features Section */}
      <section className="py-24 bg-gradient-to-r from-card via-background to-card w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8 w-full">
            ...
            <Card className="border-border hover:border-secondary/50 transition-colors duration-300 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">React Development</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="border-border hover:border-primary/50 transition-colors duration-300 bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Modern Web Tools</h3>
                <p className="text-muted-foreground leading-relaxed">
