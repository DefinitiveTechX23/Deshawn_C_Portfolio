        ...
        <div className="w-full grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl leading-relaxed">
              ...
              fundamentals of web development through HTML, CSS, JavaScript, and most recently diving deep into React and Next.js.
            </p>
        ...
        <div className="space-y-8 w-full">
          {[
            ...
            },
            {
              ...
              title: "Next.js",
              description:
                "Currently learning Next.js to strengthen my React foundation and gain experience building production-ready, full-stack applications with server-side rendering and SEO optimization.",
              status: "Learning",
            },
            {
              phase: "Future Goals",
